...
# Unit tests for GongAPI::PartyContextField
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PartyContextField' do
  before do
    # run before each test
    @instance = GongAPI::PartyContextField.new
  end
  ...
  describe 'test an instance of PartyContextField' do
    it 'should create an instance of PartyContextField' do
      expect(@instance).to be_instance_of(GongAPI::PartyContextField)
    end
  end
