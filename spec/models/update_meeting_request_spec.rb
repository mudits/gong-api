...
# Unit tests for GongAPI::UpdateMeetingRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UpdateMeetingRequest' do
  before do
    # run before each test
    @instance = GongAPI::UpdateMeetingRequest.new
  end
  ...
  describe 'test an instance of UpdateMeetingRequest' do
    it 'should create an instance of UpdateMeetingRequest' do
      expect(@instance).to be_instance_of(GongAPI::UpdateMeetingRequest)
    end
  end
