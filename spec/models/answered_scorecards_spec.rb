...
# Unit tests for GongAPI::AnsweredScorecards
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AnsweredScorecards' do
  before do
    # run before each test
    @instance = GongAPI::AnsweredScorecards.new
  end
  ...
  describe 'test an instance of AnsweredScorecards' do
    it 'should create an instance of AnsweredScorecards' do
      expect(@instance).to be_instance_of(GongAPI::AnsweredScorecards)
    end
  end
  describe 'test attribute "answered_scorecards"' do
    it 'should work' do
