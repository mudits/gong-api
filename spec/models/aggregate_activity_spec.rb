...
# Unit tests for GongAPI::AggregateActivity
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AggregateActivity' do
  before do
    # run before each test
    @instance = GongAPI::AggregateActivity.new
  end
  ...
  describe 'test an instance of AggregateActivity' do
    it 'should create an instance of AggregateActivity' do
      expect(@instance).to be_instance_of(GongAPI::AggregateActivity)
    end
  end
