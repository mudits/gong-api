...
# Unit tests for GongAPI::AggregateActivityWithDates
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AggregateActivityWithDates' do
  before do
    # run before each test
    @instance = GongAPI::AggregateActivityWithDates.new
  end
  ...
  describe 'test an instance of AggregateActivityWithDates' do
    it 'should create an instance of AggregateActivityWithDates' do
      expect(@instance).to be_instance_of(GongAPI::AggregateActivityWithDates)
    end
  end
