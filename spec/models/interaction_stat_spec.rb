...
# Unit tests for GongAPI::InteractionStat
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InteractionStat' do
  before do
    # run before each test
    @instance = GongAPI::InteractionStat.new
  end
  ...
  describe 'test an instance of InteractionStat' do
    it 'should create an instance of InteractionStat' do
      expect(@instance).to be_instance_of(GongAPI::InteractionStat)
    end
  end
