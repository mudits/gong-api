...
# Unit tests for GongAPI::CallInteraction
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CallInteraction' do
  before do
    # run before each test
    @instance = GongAPI::CallInteraction.new
  end
  ...
  describe 'test an instance of CallInteraction' do
    it 'should create an instance of CallInteraction' do
      expect(@instance).to be_instance_of(GongAPI::CallInteraction)
    end
  end
