...
# Unit tests for GongAPI::Collaboration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Collaboration' do
  before do
    # run before each test
    @instance = GongAPI::Collaboration.new
  end
  ...
  describe 'test an instance of Collaboration' do
    it 'should create an instance of Collaboration' do
      expect(@instance).to be_instance_of(GongAPI::Collaboration)
    end
  end
