...
# Unit tests for GongAPI::ManualAssociationResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ManualAssociationResponse' do
  before do
    # run before each test
    @instance = GongAPI::ManualAssociationResponse.new
  end
  ...
  describe 'test an instance of ManualAssociationResponse' do
    it 'should create an instance of ManualAssociationResponse' do
      expect(@instance).to be_instance_of(GongAPI::ManualAssociationResponse)
    end
  end
