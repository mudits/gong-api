...
# Unit tests for GongAPI::UserSimpleMetadata
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserSimpleMetadata' do
  before do
    # run before each test
    @instance = GongAPI::UserSimpleMetadata.new
  end
  ...
  describe 'test an instance of UserSimpleMetadata' do
    it 'should create an instance of UserSimpleMetadata' do
      expect(@instance).to be_instance_of(GongAPI::UserSimpleMetadata)
    end
  end
