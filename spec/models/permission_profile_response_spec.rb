...
# Unit tests for GongAPI::PermissionProfileResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PermissionProfileResponse' do
  before do
    # run before each test
    @instance = GongAPI::PermissionProfileResponse.new
  end
  ...
  describe 'test an instance of PermissionProfileResponse' do
    it 'should create an instance of PermissionProfileResponse' do
      expect(@instance).to be_instance_of(GongAPI::PermissionProfileResponse)
    end
  end
