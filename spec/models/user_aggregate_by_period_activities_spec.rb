...
# Unit tests for GongAPI::UserAggregateByPeriodActivities
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserAggregateByPeriodActivities' do
  before do
    # run before each test
    @instance = GongAPI::UserAggregateByPeriodActivities.new
  end
  ...
  describe 'test an instance of UserAggregateByPeriodActivities' do
    it 'should create an instance of UserAggregateByPeriodActivities' do
      expect(@instance).to be_instance_of(GongAPI::UserAggregateByPeriodActivities)
    end
  end
  describe 'test attribute "user_aggregate_activity"' do
    it 'should work' do
