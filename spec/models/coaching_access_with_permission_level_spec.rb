...
# Unit tests for GongAPI::CoachingAccessWithPermissionLevel
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CoachingAccessWithPermissionLevel' do
  before do
    # run before each test
    @instance = GongAPI::CoachingAccessWithPermissionLevel.new
  end
  ...
  describe 'test an instance of CoachingAccessWithPermissionLevel' do
    it 'should create an instance of CoachingAccessWithPermissionLevel' do
      expect(@instance).to be_instance_of(GongAPI::CoachingAccessWithPermissionLevel)
    end
  end
