...
# Unit tests for GongAPI::SpecificCall
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SpecificCall' do
  before do
    # run before each test
    @instance = GongAPI::SpecificCall.new
  end
  ...
  describe 'test an instance of SpecificCall' do
    it 'should create an instance of SpecificCall' do
      expect(@instance).to be_instance_of(GongAPI::SpecificCall)
    end
  end
