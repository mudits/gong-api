...
# Unit tests for GongAPI::RequestMultipleUsersRequestWithCreationDates
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RequestMultipleUsersRequestWithCreationDates' do
  before do
    # run before each test
    @instance = GongAPI::RequestMultipleUsersRequestWithCreationDates.new
  end
  ...
  describe 'test an instance of RequestMultipleUsersRequestWithCreationDates' do
    it 'should create an instance of RequestMultipleUsersRequestWithCreationDates' do
      expect(@instance).to be_instance_of(GongAPI::RequestMultipleUsersRequestWithCreationDates)
    end
  end
