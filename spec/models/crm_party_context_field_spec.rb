...
# Unit tests for GongAPI::CrmPartyContextField
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CrmPartyContextField' do
  before do
    # run before each test
    @instance = GongAPI::CrmPartyContextField.new
  end
  ...
  describe 'test an instance of CrmPartyContextField' do
    it 'should create an instance of CrmPartyContextField' do
      expect(@instance).to be_instance_of(GongAPI::CrmPartyContextField)
    end
  end
