...
# Unit tests for GongAPI::GenericCrmIntegration
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GenericCrmIntegration' do
  before do
    # run before each test
    @instance = GongAPI::GenericCrmIntegration.new
  end
  ...
  describe 'test an instance of GenericCrmIntegration' do
    it 'should create an instance of GenericCrmIntegration' do
      expect(@instance).to be_instance_of(GongAPI::GenericCrmIntegration)
    end
  end
