...
# Unit tests for GongAPI::Records
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Records' do
  before do
    # run before each test
    @instance = GongAPI::Records.new
  end
  ...
  describe 'test an instance of Records' do
    it 'should create an instance of Records' do
      expect(@instance).to be_instance_of(GongAPI::Records)
    end
  end
  ...
  describe 'test attribute "current_page_size"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
