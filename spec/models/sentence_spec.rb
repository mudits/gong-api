...
# Unit tests for GongAPI::Sentence
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Sentence' do
  before do
    # run before each test
    @instance = GongAPI::Sentence.new
  end
  ...
  describe 'test an instance of Sentence' do
    it 'should create an instance of Sentence' do
      expect(@instance).to be_instance_of(GongAPI::Sentence)
    end
  end
