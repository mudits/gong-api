...
# Unit tests for GongAPI::LogsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LogsResponse' do
  before do
    # run before each test
    @instance = GongAPI::LogsResponse.new
  end
  ...
  describe 'test an instance of LogsResponse' do
    it 'should create an instance of LogsResponse' do
      expect(@instance).to be_instance_of(GongAPI::LogsResponse)
    end
  end
