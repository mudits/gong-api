...
# Unit tests for GongAPI::CallsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CallsResponse' do
  before do
    # run before each test
    @instance = GongAPI::CallsResponse.new
  end
  ...
  describe 'test an instance of CallsResponse' do
    it 'should create an instance of CallsResponse' do
      expect(@instance).to be_instance_of(GongAPI::CallsResponse)
    end
  end
