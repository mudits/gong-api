...
# Unit tests for GongAPI::RequestCallsAccessGetDto
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RequestCallsAccessGetDto' do
  before do
    # run before each test
    @instance = GongAPI::RequestCallsAccessGetDto.new
  end
  ...
  describe 'test an instance of RequestCallsAccessGetDto' do
    it 'should create an instance of RequestCallsAccessGetDto' do
      expect(@instance).to be_instance_of(GongAPI::RequestCallsAccessGetDto)
    end
  end
