...
# Unit tests for GongAPI::EmailMessage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EmailMessage' do
  before do
    # run before each test
    @instance = GongAPI::EmailMessage.new
  end
  ...
  describe 'test an instance of EmailMessage' do
    it 'should create an instance of EmailMessage' do
      expect(@instance).to be_instance_of(GongAPI::EmailMessage)
    end
  end
  ...
  describe 'test attribute "message_hash"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
