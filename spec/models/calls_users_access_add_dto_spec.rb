...
# Unit tests for GongAPI::CallsUsersAccessAddDto
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CallsUsersAccessAddDto' do
  before do
    # run before each test
    @instance = GongAPI::CallsUsersAccessAddDto.new
  end
  ...
  describe 'test an instance of CallsUsersAccessAddDto' do
    it 'should create an instance of CallsUsersAccessAddDto' do
      expect(@instance).to be_instance_of(GongAPI::CallsUsersAccessAddDto)
    end
  end
