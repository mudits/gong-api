...
# Unit tests for GongAPI::MeetingsErrorResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MeetingsErrorResponse' do
  before do
    # run before each test
    @instance = GongAPI::MeetingsErrorResponse.new
  end
  ...
  describe 'test an instance of MeetingsErrorResponse' do
    it 'should create an instance of MeetingsErrorResponse' do
      expect(@instance).to be_instance_of(GongAPI::MeetingsErrorResponse)
    end
  end
  ...
  describe 'test attribute "fix_url"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "user_facing_error"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
