...
# Unit tests for GongAPI::MultipleUsersRequestWithCreationDates
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MultipleUsersRequestWithCreationDates' do
  before do
    # run before each test
    @instance = GongAPI::MultipleUsersRequestWithCreationDates.new
  end
  ...
  describe 'test an instance of MultipleUsersRequestWithCreationDates' do
    it 'should create an instance of MultipleUsersRequestWithCreationDates' do
      expect(@instance).to be_instance_of(GongAPI::MultipleUsersRequestWithCreationDates)
    end
  end
  describe 'test attribute "created_from_date_time"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "created_to_date_time"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "include_avatars"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
