...
# Unit tests for GongAPI::DeleteMeetingRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeleteMeetingRequest' do
  before do
    # run before each test
    @instance = GongAPI::DeleteMeetingRequest.new
  end
  ...
  describe 'test an instance of DeleteMeetingRequest' do
    it 'should create an instance of DeleteMeetingRequest' do
      expect(@instance).to be_instance_of(GongAPI::DeleteMeetingRequest)
    end
  end
