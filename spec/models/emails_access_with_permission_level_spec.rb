...
# Unit tests for GongAPI::EmailsAccessWithPermissionLevel
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EmailsAccessWithPermissionLevel' do
  before do
    # run before each test
    @instance = GongAPI::EmailsAccessWithPermissionLevel.new
  end
  ...
  describe 'test an instance of EmailsAccessWithPermissionLevel' do
    it 'should create an instance of EmailsAccessWithPermissionLevel' do
      expect(@instance).to be_instance_of(GongAPI::EmailsAccessWithPermissionLevel)
    end
  end
