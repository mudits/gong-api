...
# Unit tests for GongAPI::CallParticipant
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CallParticipant' do
  before do
    # run before each test
    @instance = GongAPI::CallParticipant.new
  end
  ...
  describe 'test an instance of CallParticipant' do
    it 'should create an instance of CallParticipant' do
      expect(@instance).to be_instance_of(GongAPI::CallParticipant)
    end
  end
  ...
  describe 'test attribute "media_channel_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
