...
# Unit tests for GongAPI::IdMediaBody
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IdMediaBody' do
  before do
    # run before each test
    @instance = GongAPI::IdMediaBody.new
  end
  ...
  describe 'test an instance of IdMediaBody' do
    it 'should create an instance of IdMediaBody' do
      expect(@instance).to be_instance_of(GongAPI::IdMediaBody)
    end
  end
