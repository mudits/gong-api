...
# Unit tests for GongAPI::Scorecards
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Scorecards' do
  before do
    # run before each test
    @instance = GongAPI::Scorecards.new
  end
  ...
  describe 'test an instance of Scorecards' do
    it 'should create an instance of Scorecards' do
      expect(@instance).to be_instance_of(GongAPI::Scorecards)
    end
  end
  ...
  describe 'test attribute "scorecards"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
