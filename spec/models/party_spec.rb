...
# Unit tests for GongAPI::Party
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Party' do
  before do
    # run before each test
    @instance = GongAPI::Party.new
  end
  ...
  describe 'test an instance of Party' do
    it 'should create an instance of Party' do
      expect(@instance).to be_instance_of(GongAPI::Party)
    end
  end
  describe 'test attribute "affiliation"' do
    it 'should work' do
      ...
      #   expect { @instance.affiliation = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "methods"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["Attendee", "Invitee"])
      # validator.allowable_values.each do |value|
