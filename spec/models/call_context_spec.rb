...
# Unit tests for GongAPI::CallContext
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CallContext' do
  before do
    # run before each test
    @instance = GongAPI::CallContext.new
  end
  ...
  describe 'test an instance of CallContext' do
    it 'should create an instance of CallContext' do
      expect(@instance).to be_instance_of(GongAPI::CallContext)
    end
  end
