...
# Unit tests for GongAPI::Monologue
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Monologue' do
  before do
    # run before each test
    @instance = GongAPI::Monologue.new
  end
  ...
  describe 'test an instance of Monologue' do
    it 'should create an instance of Monologue' do
      expect(@instance).to be_instance_of(GongAPI::Monologue)
    end
  end
