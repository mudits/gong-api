...
# Unit tests for GongAPI::Snippet
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Snippet' do
  before do
    # run before each test
    @instance = GongAPI::Snippet.new
  end
  ...
  describe 'test an instance of Snippet' do
    it 'should create an instance of Snippet' do
      expect(@instance).to be_instance_of(GongAPI::Snippet)
    end
  end
  describe 'test attribute "from_sec"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "to_sec"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
