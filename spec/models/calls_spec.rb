...
# Unit tests for GongAPI::Calls
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Calls' do
  before do
    # run before each test
    @instance = GongAPI::Calls.new
  end
  ...
  describe 'test an instance of Calls' do
    it 'should create an instance of Calls' do
      expect(@instance).to be_instance_of(GongAPI::Calls)
    end
  end
