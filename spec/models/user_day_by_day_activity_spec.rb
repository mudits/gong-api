...
# Unit tests for GongAPI::UserDayByDayActivity
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'UserDayByDayActivity' do
  before do
    # run before each test
    @instance = GongAPI::UserDayByDayActivity.new
  end
  ...
  describe 'test an instance of UserDayByDayActivity' do
    it 'should create an instance of UserDayByDayActivity' do
      expect(@instance).to be_instance_of(GongAPI::UserDayByDayActivity)
    end
  end
  describe 'test attribute "user_daily_activity_stats"' do
    it 'should work' do
