...
# Unit tests for GongAPI::GetGenericCrmObjectsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetGenericCrmObjectsResponse' do
  before do
    # run before each test
    @instance = GongAPI::GetGenericCrmObjectsResponse.new
  end
  ...
  describe 'test an instance of GetGenericCrmObjectsResponse' do
    it 'should create an instance of GetGenericCrmObjectsResponse' do
      expect(@instance).to be_instance_of(GongAPI::GetGenericCrmObjectsResponse)
    end
  end
  describe 'test attribute "crm_objects_map"' do
    it 'should work' do
