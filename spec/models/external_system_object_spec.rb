...
# Unit tests for GongAPI::ExternalSystemObject
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ExternalSystemObject' do
  before do
    # run before each test
    @instance = GongAPI::ExternalSystemObject.new
  end
  ...
  describe 'test an instance of ExternalSystemObject' do
    it 'should create an instance of ExternalSystemObject' do
      expect(@instance).to be_instance_of(GongAPI::ExternalSystemObject)
    end
  end
  ...
  describe 'test attribute "object_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["Conversation", "Task"])
