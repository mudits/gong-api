...
module GongAPI
  class CompanyUsersIntercationStatsResponse
    ...
    attr_accessor :people_interaction_stats
    ...
    def self.attribute_map
      {
        ...
        :'people_interaction_stats' => :'peopleInteractionStats',
        :'records' => :'records',
    ...
    def self.openapi_types
      {
        ...
        :'people_interaction_stats' => :'Object',
        :'records' => :'Object',
        :'request_id' => :'Object',
        :'time_zone' => :'Object',
        :'to_date_time' => :'Object'
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `GongAPI::CompanyUsersIntercationStatsResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `GongAPI::CompanyUsersIntercationStatsResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'people_interaction_stats')
        if (value = attributes[:'people_interaction_stats']).is_a?(Array)
          self.people_interaction_stats = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          people_interaction_stats == o.people_interaction_stats &&
          records == o.records &&
    ...
    def hash
      [from_date_time, people_interaction_stats, records, request_id, time_zone, to_date_time].hash
    end
