...
module GongAPI
  # Basic association details such as call Id, etc.
  class ManualAssociationsBasicData
    # List of all association objects.
    attr_accessor :associated_crm_objects
    ...
    # The user Id who performed the association.
    attr_accessor :user_id

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'associated_crm_objects' => :'associatedCrmObjects',
        :'call_id' => :'callId',
        :'created' => :'created',
        :'user_id' => :'userId'
      }
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `GongAPI::ManualAssociationsBasicData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `GongAPI::ManualAssociationsBasicData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'associated_crm_objects')
        if (value = attributes[:'associated_crm_objects']).is_a?(Array)
          self.associated_crm_objects = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          associated_crm_objects == o.associated_crm_objects &&
          call_id == o.call_id &&
          created == o.created &&
          user_id == o.user_id
    end
    ...
    def hash
      [associated_crm_objects, call_id, created, user_id].hash
    end
