...
module GongAPI
  class PointOfInterest
    # The snippet including the action.
    attr_accessor :snippet

    # The number of seconds from the beginning of the call that the snippet end refers to.
    attr_accessor :snippet_end_time

    # The number of seconds from the beginning of the call that the snippet start refers to.
    attr_accessor :snippet_start_time
    ...
    def self.attribute_map
      {
        :'snippet' => :'snippet',
        :'snippet_end_time' => :'snippetEndTime',
        :'snippet_start_time' => :'snippetStartTime',
    ...
    def self.openapi_types
      {
        :'snippet' => :'Object',
        :'snippet_end_time' => :'Object',
        :'snippet_start_time' => :'Object',
        :'speaker_id' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `GongAPI::PointOfInterest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `GongAPI::PointOfInterest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'snippet_end_time')
        self.snippet_end_time = attributes[:'snippet_end_time']
      end

      if attributes.key?(:'snippet_start_time')
        self.snippet_start_time = attributes[:'snippet_start_time']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          snippet == o.snippet &&
          snippet_end_time == o.snippet_end_time &&
          snippet_start_time == o.snippet_start_time &&
    ...
    def hash
      [snippet, snippet_end_time, snippet_start_time, speaker_id].hash
    end
