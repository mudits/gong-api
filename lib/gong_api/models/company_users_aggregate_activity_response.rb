...
module GongAPI
  class CompanyUsersAggregateActivityResponse
    # The date and time in the ISO-8601 format (e.g., '2018-02-18T02:30:00-07:00' or '2018-02-18T08:00:00Z', where Z stands for UTC), when the list of results starts.
    ...
    # The date and time in the ISO-8601 format (e.g., '2018-02-18T02:30:00-07:00' or '2018-02-18T08:00:00Z', where Z stands for UTC), when the list of results ends.
    attr_accessor :to_date_time

    # A list, in which each item specifies one user's activities.
    attr_accessor :users_aggregate_activity_stats
    ...
    def self.attribute_map
      {
        ...
        :'users_aggregate_activity_stats' => :'usersAggregateActivityStats'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'time_zone' => :'Object',
        :'to_date_time' => :'Object',
        :'users_aggregate_activity_stats' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `GongAPI::CompanyUsersAggregateActivityResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `GongAPI::CompanyUsersAggregateActivityResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'from_date_time')
        self.from_date_time = attributes[:'from_date_time']
      end
      ...
      if attributes.key?(:'to_date_time')
        self.to_date_time = attributes[:'to_date_time']
      end

      if attributes.key?(:'users_aggregate_activity_stats')
        if (value = attributes[:'users_aggregate_activity_stats']).is_a?(Array)
          self.users_aggregate_activity_stats = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          users_aggregate_activity_stats == o.users_aggregate_activity_stats
    end
    ...
    def hash
      [from_date_time, records, request_id, time_zone, to_date_time, users_aggregate_activity_stats].hash
    end
