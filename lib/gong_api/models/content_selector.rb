...
module GongAPI
  ...
  class ContentSelector
    ...
    attr_accessor :context_timing

    attr_accessor :exposed_fields
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `GongAPI::ContentSelector` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `GongAPI::ContentSelector`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'context_timing')
        if (value = attributes[:'context_timing']).is_a?(Array)
          self.context_timing = value
        end
      end

      if attributes.key?(:'exposed_fields')
        self.exposed_fields = attributes[:'exposed_fields']
      end
    end
    ...
    def context=(context)
      validator = EnumAttributeValidator.new('Object', ['Basic', 'Extended', 'None'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          context == o.context &&
          context_timing == o.context_timing &&
          exposed_fields == o.exposed_fields
    end
