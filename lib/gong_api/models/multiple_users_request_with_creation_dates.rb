...
module GongAPI
  # Filter parameters.
  class MultipleUsersRequestWithCreationDates
    ...
    attr_accessor :created_from_date_time
    ...
    attr_accessor :created_to_date_time
    ...
    def self.attribute_map
      {
        :'created_from_date_time' => :'createdFromDateTime',
        :'created_to_date_time' => :'createdToDateTime',
    ...
    def self.openapi_types
      {
        :'created_from_date_time' => :'Object',
        :'created_to_date_time' => :'Object',
        :'include_avatars' => :'Object',
        :'user_ids' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `GongAPI::MultipleUsersRequestWithCreationDates` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `GongAPI::MultipleUsersRequestWithCreationDates`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'created_from_date_time')
        self.created_from_date_time = attributes[:'created_from_date_time']
      end

      if attributes.key?(:'created_to_date_time')
        self.created_to_date_time = attributes[:'created_to_date_time']
      end

      if attributes.key?(:'include_avatars')
        self.include_avatars = attributes[:'include_avatars']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          created_from_date_time == o.created_from_date_time &&
          created_to_date_time == o.created_to_date_time &&
          include_avatars == o.include_avatars &&
          user_ids == o.user_ids
    end
    ...
    def hash
      [created_from_date_time, created_to_date_time, include_avatars, user_ids].hash
    end
