...
module GongAPI
  class UsersAggregateByPeriodActivity
    ...
    attr_accessor :users_aggregate_activity
    ...
    def self.attribute_map
      {
        ...
        :'users_aggregate_activity' => :'usersAggregateActivity'
      }
    end
    ...
    def self.openapi_types
      {
        :'records' => :'Object',
        :'request_id' => :'Object',
        :'users_aggregate_activity' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `GongAPI::UsersAggregateByPeriodActivity` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `GongAPI::UsersAggregateByPeriodActivity`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'users_aggregate_activity')
        if (value = attributes[:'users_aggregate_activity']).is_a?(Array)
          self.users_aggregate_activity = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          users_aggregate_activity == o.users_aggregate_activity
    end
    ...
    def hash
      [records, request_id, users_aggregate_activity].hash
    end
