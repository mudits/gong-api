...
module GongAPI
  ...
  class CallContent
    ...
    attr_accessor :tracker_occurrences
    ...
    def self.attribute_map
      {
        ...
        :'structure' => :'structure',
        :'topics' => :'topics',
        :'tracker_occurrences' => :'trackerOccurrences',
        :'trackers' => :'trackers'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `GongAPI::CallContent` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `GongAPI::CallContent`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'tracker_occurrences')
        self.tracker_occurrences = attributes[:'tracker_occurrences']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          topics == o.topics &&
          tracker_occurrences == o.tracker_occurrences &&
          trackers == o.trackers
    end
    ...
    def hash
      [points_of_interest, structure, topics, tracker_occurrences, trackers].hash
    end
