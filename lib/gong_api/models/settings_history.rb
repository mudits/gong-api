...
module GongAPI
  class SettingsHistory
    ...
    attr_accessor :user_settings_history

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'request_id' => :'requestId',
        :'user_settings_history' => :'userSettingsHistory'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `GongAPI::SettingsHistory` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `GongAPI::SettingsHistory`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'user_settings_history')
        if (value = attributes[:'user_settings_history']).is_a?(Array)
          self.user_settings_history = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          user_settings_history == o.user_settings_history
    end
    ...
    def hash
      [request_id, user_settings_history].hash
    end
