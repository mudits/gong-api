...
module GongAPI
  ...
  class Settings
    ...
    attr_accessor :prevent_web_conference_recording

    # True if the team member is set to import telephony calls from by Gong, false if not.
    attr_accessor :telephony_calls_imported

    # True if the team member is set to be recorded by Gong, false if not.
    attr_accessor :web_conferences_recorded

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'emails_imported' => :'emailsImported',
        :'non_recorded_meetings_imported' => :'nonRecordedMeetingsImported',
        :'prevent_email_import' => :'preventEmailImport',
        :'prevent_web_conference_recording' => :'preventWebConferenceRecording',
        :'telephony_calls_imported' => :'telephonyCallsImported',
        :'web_conferences_recorded' => :'webConferencesRecorded'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `GongAPI::Settings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `GongAPI::Settings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'emails_imported')
        self.emails_imported = attributes[:'emails_imported']
      end

      if attributes.key?(:'non_recorded_meetings_imported')
        self.non_recorded_meetings_imported = attributes[:'non_recorded_meetings_imported']
      end

      if attributes.key?(:'prevent_email_import')
        self.prevent_email_import = attributes[:'prevent_email_import']
      end

      if attributes.key?(:'prevent_web_conference_recording')
        self.prevent_web_conference_recording = attributes[:'prevent_web_conference_recording']
      end

      if attributes.key?(:'telephony_calls_imported')
        self.telephony_calls_imported = attributes[:'telephony_calls_imported']
      end

      if attributes.key?(:'web_conferences_recorded')
        self.web_conferences_recorded = attributes[:'web_conferences_recorded']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          emails_imported == o.emails_imported &&
          non_recorded_meetings_imported == o.non_recorded_meetings_imported &&
          prevent_email_import == o.prevent_email_import &&
          prevent_web_conference_recording == o.prevent_web_conference_recording &&
          telephony_calls_imported == o.telephony_calls_imported &&
          web_conferences_recorded == o.web_conferences_recorded
    end
    ...
    def hash
      [emails_imported, non_recorded_meetings_imported, prevent_email_import, prevent_web_conference_recording, telephony_calls_imported, web_conferences_recorded].hash
    end
